...
<div class="listing-search-bar">
    <div class="container-fluid" style="max-width:1320px;margin:0 auto;padding:0 15px;">
        <div class="listing-search-row">
            <form method="GET" action="<?= SITE_URL ?>properties.php" class="listing-search-form">
                <i class="fas fa-search"></i>
                <input type="text" name="q" value="<?= htmlspecialchars($search) ?>" placeholder="Search Location, Builder or Project Name...">
    ...
    <div class="col-lg-9 col-xl-9">
        ...
        <div class="prop-list-card">
            ...
            <div class="prop-list-body">
                <a href="<?= SITE_URL ?>property-detail.php?slug=<?= htmlspecialchars($prop['slug'] ?? '') ?>" class="prop-list-title">
                    <?= htmlspecialchars($prop['title']) ?>
                </a>
                <p class="prop-list-location">
                    <i class="fas fa-map-marker-alt"></i>
                ...
                <div class="prop-list-footer">
                    ...
                    <div class="prop-list-actions">
                        ...
                        <a href="<?= SITE_URL ?>property-detail.php?slug=<?= htmlspecialchars($prop['slug'] ?? '') ?>" class="btn-enquire">
        ...
        <nav class="pagination-wrap">
            <ul class="pagination">
                ...
                <?php if ($start > 2): ?><li class="page-item disabled"><span class="page-link">...</span></li><?php endif; endif;
                for ($i = $start; $i <= $end; $i++): ?>
